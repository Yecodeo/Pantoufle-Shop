<?php
/**
 * liste de produit dans le panier
...
<main id="cart"  class="container">
    ...
    <?php if(empty($cart)) : ?>
        ...
        <div class="notification is-warning">
          <p>
            <i class="fa fa-shopping-cart icon is-large fa-2x" aria-hidden="true"></i>
            Votre panier est vide! Allez faire un peu de shopping et revenez vite
          </p>
        </div>
    <?php else : ?>
    	<table class="table is-fullwidth is-narrow">
    		...
    		<tbody>
          <!-- list tout les produits dans le panier -->
        ...
        <form class="pull-right" action="cart.php" method="post">
          ...
          <?php endif; // if loggedin() ?>
        </form>
    <?php endif; // if empty($cart)  ?>
</main>
